...
from models.actor_critic import ActorCritic, ActionSpaceType, ObservationSpaceType


def create_actor_critic(observation_space: gym.Space, action_space: gym.Space, device="cpu") -> ActorCritic:
    """
